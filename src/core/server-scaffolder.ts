...
export class ServerScaffolder {
  ...
  private loadTemplates(): void {
    ...
    for (const file of templateFiles) {
      ...
      try {
        ...
        this.templates.set(file, Handlebars.compile(this.getInlineTemplate(file)));
      }
    }
  }
  ...
  private generateServerFile(tools: GeneratedTool[], config: ServerConfig): GeneratedFile {
  ...
  private generateReadme(tools: GeneratedTool[], config: ServerConfig): GeneratedFile {
